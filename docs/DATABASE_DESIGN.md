...
**Dagi Spa Management System** — PostgreSQL schema.
...
- **Super admin:** `super@dagispa.com` / `admin123` (company_id = NULL, platform role).
- **Demo tenant admin:** `admin@dagispa.com` / `admin123` (company_id = 1).
