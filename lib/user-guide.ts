    ...
    pages: [
      {
        ...
        summary: "A touch-friendly visit board with large status cards for existing customers and walk-in guests, from arrival through cashier handoff.",
        actions: ["Create visit", "Tap status filter", "Search/date filter", "Tap card to open order workspace"],
      ...
      },
      {
        ...
        summary: "A tablet-first restaurant-order style workspace: large classified service tiles on the left and a live service cart with touch quantity controls on the right.",
        actions: ["Assign therapist", "Start treatment", "Tap service tile", "Increase/decrease quantity", "Remove line", "Save notes", "Finish treatment", "Print draft", "Mark handed to cashier"],
