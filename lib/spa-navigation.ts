...
export const sidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Spa Sales / POS", href: "/dashboard/spa/sales", icon: "bi-shop", resource: "spa_sales" },
    ],
  },
  {
    name: "Gym",
  ...
  },
  {
    ...
    moduleCode: "membership",
    links: [
      { name: "Access", href: "/dashboard/spa/reports/access", icon: "bi-shield-check", resource: "reports_access" },
