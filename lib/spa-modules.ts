...
export const SPA_MODULES: SpaModuleDefinition[] = [
  ...
  moduleDefinition({
    ...
    description: "Configure the operational treatment catalogue and standard duration. Pricing stays in the separate POS.",
    ...
    fields: [
      ...
      { key: "service_code", label: "Service Code", type: "text", list: true, placeholder: "Optional reference used by the cashier" },
  ...
  moduleDefinition({
    ...
    description: "Group treatments for operational delivery and usage tracking. Package pricing stays in the separate POS.",
    ...
    fields: [
      ...
      { key: "package_code", label: "Package Code", type: "text", required: true, list: true },
